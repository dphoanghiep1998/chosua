...
class AppOpenAdManager constructor(
    ...
    private val idOpenAds03: String?
) {
    ...
    fun loadAd() {
        ...
        loadAdsPrepare(idOpenAds01, onAdLoadFail = {
            idOpenAds02?.let {
                loadAdsPrepare(it, onAdLoadFail = {
                    if (idOpenAds03 != null) {
                        loadAdsPrepare(idOpenAds03, onAdLoadFail = {
                        })
                    }
                })
            }
    ...
    private fun showAdIfAvailable(
        ...
        appOpenAd?.setOnPaidEventListener {
            Utils.postRevenueAdjust(it, appOpenAd?.adUnitId)
        }
